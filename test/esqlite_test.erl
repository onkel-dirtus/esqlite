...
sqlite_version_test() ->
    ...
    ?assertEqual({row, {<<"3.29.0">>}}, esqlite3:step(Stmt)),
    ok.
...
sqlite_source_id_test() ->
    ...
    ?assertEqual({row,{<<"2019-07-10 17:32:03 fc82b73eaac8b36950e527f12c4b5dc1e147e6f4ad2217ae43ad82882a88bfa6">>}}, esqlite3:step(Stmt)),
    ok.
